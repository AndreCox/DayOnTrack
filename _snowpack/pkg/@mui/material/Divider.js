...
function getDividerUtilityClass(slot) {
  return (0, base.generateUtilityClass)('MuiDivider', slot);
}

const dividerClasses = (0, base.generateUtilityClasses)('MuiDivider', ['root', 'absolute', 'fullWidth', 'inset', 'middle', 'flexItem', 'light', 'vertical', 'withChildren', 'withChildrenVertical', 'textAlignRight', 'textAlignLeft', 'wrapper', 'wrapperVertical']);
...
const useUtilityClasses = ownerState => {
  ...
  return (0, base.unstable_composeClasses)(slots, dividerClasses_1.getDividerUtilityClass, classes);
};
...
const DividerRoot = (0, _styled.default)('div', {
  ...
  borderColor: (0, esm.alpha)(theme.palette.divider, 0.08)
...
const Divider = /*#__PURE__*/React.forwardRef(function Divider(inProps, ref) {
  ...
  return /*#__PURE__*/(0, jsxRuntime.jsx)(DividerRoot, (0, _extends2.default)({
    as: component,
...
var __pika_web_default_export_for_treeshaking__ = /*@__PURE__*/getDefaultExportFromCjs(Divider);
