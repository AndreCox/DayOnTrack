import { f as firebase } from './common/index.esm-a962f953.js';
import { h as isMobileCordova, j as isReactNative, _ as _registerComponent, C as Component, S as SDK_VERSION, k as getModularInstance, r as registerVersion, l as isBrowserExtension, E as ErrorFactory, c as createSubscribe, n as getUA, q as querystring, p as querystringDecode, t as extractQuerystring, u as LogLevel, F as FirebaseError, v as isIE, L as Logger, w as base64Decode, x as isEmpty, y as isNode, z as isIndexedDBAvailable } from './common/index.esm2017-cf48fd95.js';
...
function _isAndroidOrIosCordovaScheme(ua = getUA()) {
    return !!((_getCurrentScheme$1() === 'file:' || _getCurrentScheme$1() === 'ionic:') &&
...
function _isWebStorageSupported() {
    try {
        ...
        // indexedDB.
        return _isWorker$1() && isIndexedDBAvailable();
    }
    return false;
}
/**
...
PhoneAuthProvider$1.PHONE_SIGN_IN_METHOD = PhoneAuthProvider.PHONE_SIGN_IN_METHOD;
PhoneAuthProvider$1.PROVIDER_ID = PhoneAuthProvider.PROVIDER_ID;
 ...
 * limitations under the License.
 */
const _assert$4 = _assert;
class RecaptchaVerifier$1 {
    constructor(container, parameters, app = firebase.app()) {
        var _a;
        // API key is required for web client RPC calls.
        _assert$4((_a = app.options) === null || _a === void 0 ? void 0 : _a.apiKey, "invalid-api-key" /* INVALID_API_KEY */, {
            appName: app.name
        });
        this._delegate = new RecaptchaVerifier(container, 
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        parameters, 
        // TODO: remove ts-ignore when moving types from auth-types to auth-compat
        // @ts-ignore
...
function registerAuthCompat(instance) {
    instance.INTERNAL.registerComponent(new Component(AUTH_TYPE, container => {
        ...
        PhoneAuthProvider: PhoneAuthProvider$1,
        PhoneMultiFactorGenerator: PhoneMultiFactorGenerator,
        RecaptchaVerifier: RecaptchaVerifier$1,
...
a.firstChild.data=String(b);}else {for(var c;c=a.firstChild;)a.removeChild(c);a.appendChild(Sc(a).createTextNode(String(b)));}}function ad(a,b){return b?bd(a,function(c){return !b||q(c.className)&&Ma(c.className.split(/\s+/),b)}):null}function bd(a,b){for(;a;){if(b(a))return a;a=a.parentNode;}return null}function Rc(a){this.a=a||n.document||document;}Rc.prototype.N=function(){return q(void 0)?this.a.getElementById(void 0):void 0};var cd={Fc:!0},dd={Hc:!0},ed={Ec:!0},fd={Gc:!0};function gd(){throw Error("Do not instantiate directly");
...
message:this.message}};var Od="firebaseui/";function Pd(){this.T=this.T;this.C=this.C;}var Qd=0;Pd.prototype.T=!1;Pd.prototype.m=function(){if(!this.T&&(this.T=!0,this.o(),0!=Qd)){var a=this[ua]||(this[ua]=++va);}};function Sd(a,b){a.T?ka(void 0)?
...
if(!f.sa&&f.listener==b&&f.capture==!!c&&f.La==d)return e}return -1}var he="closure_lm_"+(1E6*Math.random()|0),ie={};function ke(a,b,c,d,e){if(d&&d.once)return le(a,b,c,d,e);if(qa(b)){for(var f=0;f<b.length;f++)ke(a,b[f],c,d,e);return null}c=me(c);return a&&a[ae]?a.J.add(String(b),c,!1,ta(d)?!!d.capture:!!d,e):ne(a,b,c,!1,d,e)}function ne(a,b,c,d,e,f){if(!b)throw Error("Invalid event type");var g=ta(e)?!!e.capture:!!e,h=oe(a);h||(a[he]=h=new ee(a));c=h.add(b,c,d,g,f);if(c.proxy)return c;d=pe();
c.proxy=d;d.src=a;d.listener=c;if(a.addEventListener)Xd||(e=g),void 0===e&&(e=!1),a.addEventListener(b.toString(),d,e);else if(a.attachEvent)a.attachEvent(qe(b.toString()),d);else if(a.addListener&&a.removeListener)a.addListener(d);else throw Error("addEventListener and attachEvent are unavailable.");return c}function pe(){var a=re,b=Vd?function(c){return a.call(b.src,b.listener,c)}:function(c){c=a.call(b.src,b.listener,c);if(!c)return c};return b}function le(a,b,c,d,e){if(qa(b)){for(var f=0;f<
...
function zf(){Ba.call(this);}w(zf,Ba);zf.prototype.message="Deferred was canceled";zf.prototype.name="CanceledError";function Hf(a){this.a=n.setTimeout(r(this.h,this),0);this.g=a;}Hf.prototype.h=function(){delete Gf[this.a];throw this.g;};var Gf={};function If(a){var c=document,d=uc(a).toString(),e=document.createElement("SCRIPT"),f={rb:e,sb:void 0},g=new xf(f),h=null,k=5E3;(h=window.setTimeout(function(){Jf(e,!0);var p=new Kf(Lf,"Timeout reached for loading script "+
d);Af(g);Bf(g,!1,p);},k),f.sb=h);e.onload=e.onreadystatechange=function(){e.readyState&&"loaded"!=e.readyState&&"complete"!=e.readyState||(Jf(e,!1,h),g.callback(null));};e.onerror=function(){Jf(e,!0,h);var p=new Kf(Mf,"Error while loading script "+d);Af(g);Bf(g,!1,p);};f={};gb(f,{type:"text/javascript",charset:"UTF-8"});Wc(e,f);Mc(e,a);Nf(c).appendChild(e);return g}function Nf(a){var b=(a||document).getElementsByTagName("HEAD");return b&&0!=b.length?b[0]:a.documentElement}function yf(){if(this&&
